...
export default function PostPage() {
  ...
  return (
    <main className='p-3 flex- flex-col max-w-6xl mx-auto min-h-screen'>
        ...
        <img src={post && post.image} alt={post && post.title} className='mt-10 p-3 max-h-[600px] w-full max-w-2xl object-cover' />
        <div className='flex justify-between p-3 border-b border-slate-500 mx-auto w-full max-w-2xl text-xs'>
            <span>{post && new Date(post.reatedAt).toLocaleDateString()}</span>
        ...
        <div className="flex flex-col justify-center items-center mb-5">
            <h1 className="text-xl mt-5">مقالات اخیر</h1>
