...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formData).length === 0) {
      setUpdateUserError('هیچ تغییراتی انجام نشد');
      return;
    }
    if (imageFileUploading) {
      setUpdateUserError('تغییرات با موفقیت انجام شد');
      return;
    }
    try {
      ...
      if (!res.ok) {
        ...
        setUpdateUserSuccess("تغییرات با موفقیت انجام شد");
      }
    } catch (error) {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full' dir='rtl'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        >
          {loading ? 'در حال بارگزاری...' : 'به روز رسانی'}
        </Button>
        {currentUser.isAdmin && (
          <Link to={'/create-post'}>
            <Button
      ...
      >
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            آیا از حذف این اکانت اطمینان دارید؟
            </h3>
